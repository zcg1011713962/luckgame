local config = {
    ...
    -- 结果权重
    MultWeight = {
        {min=100, max=150, weight=340},
        {min=151, max=200, weight=236},
        {min=201, max=300, weight=160},
        {min=301, max=400, weight=95},
        {min=401, max=600, weight=60},
        {min=601, max=900, weight=40},
        {min=901, max=1200, weight=30},
        {min=1201, max=1600, weight=20},
