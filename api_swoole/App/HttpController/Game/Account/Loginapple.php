...
* 苹果登录
*/
class Loginapple extends Controller
{
    protected function onRequest($action, $method) :? bool
    {
        ...
        return $this->colationPars(
            [
                ...
                'ignoreauth'=> [true, 'abs', function($f){ return $f > -1; }],
            ]
        );
    }
    ...
    {
        if (! $this->thirdparty_model->check_apple_code($this->Pars['account'], $this->Pars['id_token'])) {
