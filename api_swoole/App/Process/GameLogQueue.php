...
class GameLogQueue extends AbstractProcess
{
                        ...
                        if (! $isRun) {
                            ...
                            while (true) {
                                ...
                                if (isset($_r[0]) && $_r[0]) {
                                    ...
                                    Logger::getInstance()->log($_httplogstr, 'queue-gplay');
                                    $model->getModels()->finance_model->postPlayerGameLog($_r[0]);
                                }
                            }
                            $isRun = false;
                        }
