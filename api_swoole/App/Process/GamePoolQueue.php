...
class GamePoolQueue extends AbstractProcess
{
                        ...
                        if (! $isRun) {
                            ...
                            while (true) {
                                ...
                                if (isset($_r[0]) && $_r[0]) {
                                    ...
                                    Logger::getInstance()->log($_httplogstr, 'queue-gpool');
                                    $model->getModels()->finance_model->postPlayerGamePool($_r[0]);
                                }
                            }
                            $isRun = false;
                        }
